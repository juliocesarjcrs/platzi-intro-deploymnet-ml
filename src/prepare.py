...
my_remote = 'myremote'
movie_data_path = api.read('dataset/movies.csv', remote=my_remote)
finantial_data_path = api.read('dataset/finantials.csv', remote=my_remote)
opening_data_path = api.read('dataset/opening_gross.csv', remote=my_remote)
